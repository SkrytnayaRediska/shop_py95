# Generated by Django 5.0.3 on 2024-05-29 10:03
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0003_customuser_is_notification_required'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='oauth2_provider_applications', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
